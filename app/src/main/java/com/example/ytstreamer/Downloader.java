...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onSearch(String song) {
        ...
        editor.putString("LastSong",song);
        editor.commit();
        ...
        switch (item.getItemId() ) {
            ...
            case R.id.lyrics:
                if(current_streamer!=null) {
                    ...
                    intent.putExtra(SearchManager.QUERY, sharedPreferences.getString("LastSong","none")+ " lyrics");
                    startActivity(intent);
                }

                else {
                    Toast.makeText(MainActivity.this,"Media not loaded",Toast.LENGTH_LONG).show();
                }
                break;
        }
    ...
    public void download(String name,MenuItem item,String stream_url) {
        if(!name.equals(""))
            ...
            Toast.makeText(MainActivity.this,"Please enter the file name",Toast.LENGTH_LONG).show();
    }
